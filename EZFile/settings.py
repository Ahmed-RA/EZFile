"""
Django settings for EZFile project.
...
SECRET_KEY = '----------your project created secret key goes here---------------'
...
WSGI_APPLICATION = 'EZFile.wsgi.application'
